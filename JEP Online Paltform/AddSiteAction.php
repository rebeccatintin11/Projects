...
// update the record
$max_id=mysql_query("SELECT MAX(site_id) FROM SITES");
$site_id_row = mysql_fetch_array($max_id);
$site_id = $site_id_row[0] +1;
...
&& ($_FILES["file"]["size"] < 20000)){
		...
		if(move_uploaded_file($_FILES['file']['tmp_name'],  $targetfolder)){
			...
			$result=mysql_query("INSERT INTO SITES(site_id,name,image,adress,early_dismissal,dress_code,description,phone,c_last_name,c_first_name,c_email,c_office_location,radius) VALUES('$site_id','".$name."','". $image ."','".$adress."','".$early_dismissal."','".$dress_code."','".$description."','".$phone."','".$c_last_name."','".$c_first_name."','".$c_email."','".$c_office_location."','".$radius."')");
		...
		$result=mysql_query("INSERT INTO SITES(site_id,name,adress,early_dismissal,dress_code,description,phone,c_last_name,c_first_name,c_email,c_office_location,radius) VALUES('$site_id','".$name."','".$adress."','".$early_dismissal."','".$dress_code."','".$description."','".$phone."','".$c_last_name."','".$c_first_name."','".$c_email."','".$c_office_location."','".$radius."')");
