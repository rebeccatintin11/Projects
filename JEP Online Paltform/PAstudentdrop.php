...
// for team dropdown list
    ...
    echo "</table>";
    echo"<input id= 'search' type='button' value='Search' onclick='PAshowinfo($myusername,first_name.value,last_name.value,site_id.value,course.value,professor.value,supervisor.value,major.value,room.value,car.value,housing.value,international.value,assigned_as.value,PA.value,team.value,semester.value)'>";
    echo "</form>";
